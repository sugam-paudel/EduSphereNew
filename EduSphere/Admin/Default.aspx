            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <div class="d-grid gap-2">
                        ...
                        <asp:HyperLink runat="server" NavigateUrl="~/Admin/ManageResources.aspx" CssClass="btn btn-outline-primary">
                            <i class="fas fa-folder-open me-2"></i> Manage Resources
                        </asp:HyperLink>
                        <asp:HyperLink runat="server" NavigateUrl="~/Admin/ManageDiscussions.aspx" CssClass="btn btn-outline-primary">
                            <i class="fas fa-comments me-2"></i> Manage Discussions
                        </asp:HyperLink>
                        <asp:HyperLink runat="server" NavigateUrl="~/Admin/ManageAssessments.aspx" CssClass="btn btn-outline-primary">
